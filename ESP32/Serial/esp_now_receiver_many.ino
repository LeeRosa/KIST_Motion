  ...
  //switch (sensorValue.sensorId) {
    //case SH2_GAME_ROTATION_VECTOR:
     //if(Serial.read()=='a'){
      ...
      for ( int i = 0; i < 2; i++) {
        Serial.print((float)BNO08X_struct[i].real);
        Serial.print(",");
        Serial.print((float)BNO08X_struct[i].i);
        Serial.print(",");
        Serial.print((float)BNO08X_struct[i].j);
        Serial.print(",");
        Serial.print((float)BNO08X_struct[i].k);
        Serial.print(";");
      }

      //      //Serial.print("com7--");
      Serial.print((float)sensorValue.un.gameRotationVector.real, 2);
      Serial.print(",");
      Serial.print((float)sensorValue.un.gameRotationVector.i, 2);
      Serial.print(",");
      Serial.print((float)sensorValue.un.gameRotationVector.j, 2);
      Serial.print(",");
      Serial.print((float)sensorValue.un.gameRotationVector.k, 2);
      Serial.println(";");
      //delay(10);
      //break;
